...
client.connect(err => {
    const servicesCollection = client.db("msoft").collection("services");
    const reviewCollection = client.db("msoft").collection("reviews");
    const adminCollection = client.db("msoft").collection("admin");
    const addBookCollection = client.db("msoft").collection("orders");
